...
# ---------------- PREDICTION (FIXED & SAFE) ----------------
    ...
    with col1:
        city = st.text_input("Enter City", placeholder="e.g. Surat")
                ...
                if response.status_code != 200:
                    ...
                    if "error" in res:
                        ...
                        if res["prediction"] == 1:
                            ...
                            🌧️ Rain Expected<br>
                            Confidence: {round(res["probability"]*100,2)}%<br><br>

                            🌡️ Temp: {res.get("temperature","-")}°C<br>
                            💧 Humidity: {res.get("humidity","-")}%<br>
                            🌬️ Wind: {res.get("wind","-")} km/h<br>
                            ☁️ Cloud: {res.get("cloud","-")}%<br>
                            ☀️ Condition: {res.get("condition","-")}
